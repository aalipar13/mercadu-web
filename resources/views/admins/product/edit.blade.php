...
<div class="container-fluid margin-top">    
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-4">
            {!! Form::open(['method' => 'PUT', 'route' => ['admin.product.revise', $product['id']], 'files' => true,]) !!}
                ...
                <div class="form-group{{ $errors->has('store_id') ? ' has-error' : '' }}">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            {!! Form::select('store_id', $stores, $product['store_id'], ['class' => 'form-control', 'placeholder' => 'Choose a Store']) !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group{{ $errors->has('type') ? ' has-error' : '' }}">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            {!! Form::select('type', ['simple' => 'Simple', 'group' => 'Group', 'external' => 'External', 'variable' => 'Variable', 'bid' => 'Bid'], $product['type'], ['class' => 'form-control', 'placeholder' => 'Type']) !!}
                        </div>
                    </div>
                </div>
                <div class="form-group{{ $errors->has('code') ? ' has-error' : '' }}">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            {!! Form::text('code', $product['code'], ['class' => 'form-control', 'placeholder' => 'Product Code'])!!}
                        </div>
                    </div>
                </div>
                ...
                {{-- <div class="form-group{{ $errors->has('min_quantity') ? ' has-error' : '' }}">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            {!! Form::text('min_quantity', $product['min_quantity'], ['class' => 'form-control', 'placeholder' => 'Minimum Quantity'])!!}
                        </div>
                    </div>
                </div> --}}
                <div class="form-group{{ $errors->has('should_manage_stock') ? ' has-error' : '' }}">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            {!! Form::select('should_manage_stock', ['yes' => 'Yes', 'no' => 'No'], $product['should_manage_stock'], ['class' => 'form-control', 'placeholder' => 'Should manage stock?']) !!}
                        </div>
                    </div>
                </div>
                <div class="form-group{{ $errors->has('available') ? ' has-error' : '' }}">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            {!! Form::select('available', ['yes' => 'Yes', 'no' => 'No'], $product['available'], ['class' => 'form-control', 'placeholder' => 'Available?']) !!}
                        </div>
                    </div>
                </div>
                <div class="form-group{{ $errors->has('is_sold_individually') ? ' has-error' : '' }}">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            {!! Form::select('is_sold_individually', ['yes' => 'Yes', 'no' => 'No'], $product['is_sold_individually'], ['class' => 'form-control', 'placeholder' => 'Is sold individually?']) !!}
                        </div>
                    </div>
                </div>
                <div class="form-group{{ $errors->has('regular_price') ? ' has-error' : '' }}">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            {!! Form::text('regular_price', $product['regular_price'], ['class' => 'form-control', 'placeholder' => 'Regular Price'])!!}
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group{{ $errors->has('length') ? ' has-error' : '' }}">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            {!! Form::text('length', $product['length'], ['class' => 'form-control', 'placeholder' => 'Length'])!!}
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group{{ $errors->has('purchase_note') ? ' has-error' : '' }}">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            {!! Form::textarea('purchase_note', $product['purchase_note'], ['class' => 'form-control', 'placeholder' => 'Purchaser Note'])!!}
                        </div>
                    </div>
                </div>
                <div class="form-group{{ $errors->has('should_allow_reviews') ? ' has-error' : '' }}">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            {!! Form::text('should_allow_reviews', $product['should_allow_reviews'], ['class' => 'form-control', 'placeholder' => 'Should Allow Reviews'])!!}
                        </div>
                    </div>
                </div>
                <div class="form-group">
